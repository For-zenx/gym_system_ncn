...
DEFAULT_FROM_EMAIL = os.getenv(
    "DEFAULT_FROM_EMAIL",
    "NCN Gym <{user}>".format(user=EMAIL_HOST_USER or "noreply@perfectline.local"),
)
REPORT_EMAIL_SUBJECT_PREFIX = os.getenv("REPORT_EMAIL_SUBJECT_PREFIX", "NCN Gym")
GYM_NAME = os.getenv("GYM_NAME", "NCN Gym")
